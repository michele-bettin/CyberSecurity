...
with open("C:/Users/miche/Desktop/CyberSecurity/Lez5-CryptoTool/Exercises/4_repeated_xor/encrypted.txt", 'r') as file:
...
for kl in range(5, 16):
    print(f"Lenght:/t{kl}/tFreq:/t{freq_counter(secret, shift(secret, kl))}")
